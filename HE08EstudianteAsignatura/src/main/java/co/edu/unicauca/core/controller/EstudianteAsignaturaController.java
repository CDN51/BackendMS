...
public class EstudianteAsignaturaController {
	...
	@PutMapping("/estadoON")
	@ResponseBody
	public Integer setEstadoON(@RequestBody List<String> params) {
		return estudianteAsignaturaServiceInt.setEstadoON(params);
	}
	@PutMapping("/estadoOFF")
	@ResponseBody
	public Integer setEstadoOFF(@RequestBody List<String> params) {
		return estudianteAsignaturaServiceInt.setEstadoOFF(params);
	}
